...
/// IntegrationTests' own HttpClient, handles it identically with no extra configuration. Uses
/// the case-sensitive AlertConditionJsonConverter, not the built-in JsonStringEnumConverter,
/// which matches names case-insensitively on read - see that converter's doc comment.</summary>
