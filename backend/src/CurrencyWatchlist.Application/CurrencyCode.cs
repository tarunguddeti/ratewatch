...
public static class CurrencyCode
{
    ...
    /// BaseCurrency/QuoteCurrency column, which previously restated this number independently
    /// (specs/004-strong-typing-cleanup/research.md decision 4).</summary>
    ...
    // deliberate and negligible-impact tradeoff at this call frequency (research.md decision 4).
