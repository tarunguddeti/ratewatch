...
/// <summary>The exact pair is already tracked on this watchlist - maps to 409
/// (FR-007).</summary>
...
/// rather than silently degrading, per the fail-closed currency-validation decision
/// (constitution Article IV).</summary>
public class RateProviderUnavailableException(string message) : Exception(message);

/// <summary>The provider doesn't recognize this pair at evaluation time - maps to 422
/// (docs/architecture.md's failure taxonomy: "Evaluate: 422").</summary>
